class CfgVehicles
{
	...
	{
		scope = 1;
		editorCategory ="STB73_Objects"; // This places it under "Empty" in the Eden Editor
        editorSubcategory = "STB73_Crates";
		faction = "STB73_STB";
		maximumLoad=1000000;
		hiddenselections[]=
		{
	...
	class STB73_SupplyPod_NEWACE_Medical: STB73_SupplyPod
	{
    ...
    scopeCurator = 2; // Allow spawning in Zeus
		...
		class TransportItems
		{
			...
			class _xx_STB73_PolyHemoglobinIV_250
			{
				name="STB73_PolyHemoglobinIV_250";
				count=30;
			};
			class _xx_STB73_PolyHemoglobinIV_500
			{
				name="STB73_PolyHemoglobinIV_500";
				count=20;
			};
			class _xx_STB73_PolyHemoglobinIV_1000
			{
				name="STB73_PolyHemoglobinIV_1000";
				count=10;
			};
			class _xx_STB73_PolyHemoglobinIV_2000
			{
				name="STB73_PolyHemoglobinIV_2000";
				count=5;
			};
			class _xx_STB73_MedKit
			{
				name="STB73_MedKit";
				count=5;
			};
	...
	class STB73_SupplyPod_Mortar_Ammo: STB73_SupplyPod
	{
    scope = 2; // Visible in Zeus and Eden
    scopeCurator = 2; // Allow spawning in Zeus
	...
	class STB73_SupplyPod_Mortar: STB73_SupplyPod
	{
 	 	scope = 2; // Visible in Zeus and Eden
    scopeCurator = 2; // Allow spawning in Zeus
	...
	class STB73_SupplyPod_StaticHMG: STB73_SupplyPod
  {
   		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
	...
	class STB73_SupplyPod_StaticHMGAmmo: STB73_SupplyPod
  {
	...
	class STB73_SupplyPod_StaticGMG: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
	...
	class STB73_SupplyPod_StaticGMGAmmo: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
	...
	class STB73_supply_ARGL: STB73_SupplyPod
	{
		scope=2;
		scopeCurator = 2;
		...
		class TransportMagazines
		{
			class _xx_STB73_32Rnd_762x51_Mag
			{
				magazine="STB73_32Rnd_762x51_Mag";
				count=30;
			};
			class _xx_STB73_32Rnd_762x51_Mag_Tracer
			{
				magazine="STB73_32Rnd_762x51_Mag_Tracer";
				count=30;
			};
			class _xx_STB73_60Rnd_762x51_Mag
			{
				magazine="STB73_60Rnd_762x51_Mag";
				count=30;
			};
			class _xx_STB73_60Rnd_762x51_Mag_Tracer
			{
				magazine="STB73_60Rnd_762x51_Mag_Tracer";
				count=30;
			};
			class _xx_STB73_60Rnd_762x51_Mag_Tracer_Yellow
			{
				magazine="STB73_60Rnd_762x51_Mag_Tracer_Yellow";
				count=30;
			};
			class _xx_STB73_32Rnd_762x51_Mag_Tracer_Yellow
			{
				magazine="STB73_32Rnd_762x51_Mag_Tracer_Yellow";
				count=30;
			};
		...
		class TransportWeapons
		{
			class _xx_STB73_MA37BGL
			{
				weapon="STB73_MA37BGL";
				count=3;
			};
			class _xx_STB73_MA5BGL
			{
				weapon="STB73_MA5BGL";
				count=2;
			};
	...
	class STB73_supply_Squad: STB73_SupplyPod
	{
		scope=2;
		scopeCurator = 2;
		...
		class TransportMagazines
		{
			...
			class _xx_STB73_95x40_36Rnd
			{
				magazine="STB73_95x40_36Rnd";
				count=30;
			};
			class _xx_STB73_95x40_36Rnd_T_R
			{
				magazine="STB73_95x40_36Rnd_T_R";
				count=30;
			};
			class _xx_STB73_36Rnd_95x40_HPSAP_Mag
			{
				magazine="STB73_36Rnd_95x40_HPSAP_Mag";
				count=30;
			};
			class _xx_STB73_36Rnd_95x40_HPSAP_Mag_Tracer
			{
				magazine="STB73_36Rnd_95x40_HPSAP_Mag_Tracer";
				count=30;
			};
			class _xx_STB73_48Rnd_5x23Caseless_FMJ_Mag
			{
				magazine="STB73_48Rnd_5x23Caseless_FMJ_Mag";
				count=20;
			};
			class _xx_STB73_48Rnd_5x23Caseless_FMJ_Mag_Tracer
			{
				magazine="STB73_48Rnd_5x23Caseless_FMJ_Mag_Tracer";
				count=30;
			};
			class _xx_STB73_48Rnd_5x23Caseless_NARQ_Mag
			{
				magazine="STB73_48Rnd_5x23Caseless_NARQ_Mag";
				count=20;
			};

			class _xx_STB73_60Rnd_5x23Caseless_FMJ_Mag
			{
				magazine="STB73_60Rnd_5x23Caseless_FMJ_Mag";
				count=30;
			};
			...
			class _xx_STB73_26Rnd_127x40_Mag_Black_Tracer
			{
				magazine="STB73_26Rnd_127x40_Mag_Black_Tracer";
				count=30;
			};
			class _xx_STB73_40Rnd_127x40_Drum_Black_Tracer
			{
				magazine="STB73_40Rnd_127x40_Drum_Black_Tracer";
				count=30;
			};
			class _xx_OPTRE_signalSmokeB
			{
		...
		class TransportWeapons
		{
			class _xx_STB73_M7_SMG
			{
				weapon="STB73_M7_SMG";
				count=3;
			};
			class _xx_STB73_M6DS_Carbine_Foregrip
			{
				weapon="STB73_M6DS_Carbine_Foregrip";
				count=3;
			};
			class _xx_STB73_MA37B
			{
				weapon="STB73_MA37B";
				count=3;
			};
			class _xx_STB73_MA37K
			{
				weapon="STB73_MA37K";
				count=3;
			};
			class _xx_STB73_MA5B
			{
				weapon="STB73_MA5B";
				count=3;
			};
			class _xx_STB73_MA5K
			{
				weapon="STB73_MA5K";
				count=3;
			};
			class _xx_STB73_BR55HBM1_DMR
			{
				weapon="STB73_BR55HBM1_DMR";
				count=3;
			};
			class _xx_STB73_BR55_HB
			{
				weapon="STB73_BR55_HB";
				count=3;
			};
		};
	};
	class STB73_supply_Breacher: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
		...
		class TransportMagazines
		{
			class _xx_STB73_6Rnd_8Gauge_Pellets
			{
				magazine="STB73_6Rnd_8Gauge_Pellets";
				count=10;
			};
			class _xx_STB73_6Rnd_8Gauge_Slugs
			{
				magazine="STB73_6Rnd_8Gauge_Slugs";
				count=10;
			};
			class _xx_STB73_12Rnd_8Gauge_Pellets
			{
				magazine="STB73_12Rnd_8Gauge_Pellets";
				count=10;
			};
			class _xx_STB73_12Rnd_8Gauge_Slugs
			{
				magazine="STB73_12Rnd_8Gauge_Slugs";
				count=10;
			};
			class _xx_STB73_6Rnd_8Gauge_HEDP
			{
				magazine="STB73_6Rnd_8Gauge_HEDP";
				count=10;
			};
			class _xx_STB73_12Rnd_8Gauge_HEDP
			{
				magazine="STB73_12Rnd_8Gauge_HEDP";
				count=10;
			};
		};
		class TransportWeapons
		{
			class _xx_STB73_M90A
			{
				weapon="STB73_M90A";
				count=3;
			};
	...
	class STB73_supply_Marksman: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
		...
		class TransportMagazines
		{
			...
			class _xx_STB73_15Rnd_10x40_Mag
			{
				magazine="STB73_15Rnd_10x40_Mag";
				count=30;
			};
			class _xx_STB73_15Rnd_10x40_Mag_Tracer
			{
				magazine="STB73_15Rnd_10x40_Mag_Tracer";
				count=30;
			};
			class _xx_STB73_15Rnd_10x40_Mag_Tracer_Yellow
			{
				magazine="STB73_15Rnd_10x40_Mag_Tracer_Yellow";
				count=30;
			};
		};
		class TransportWeapons
		{
			class _xx_STB73_M395S_DMR
			{
				weapon="STB73_M395S_DMR";
				count=2;
			};
			class _xx_STB73_M395_DMR
			{
				weapon="STB73_M395_DMR";
				count=2;
			};
			class _xx_STB73_M392_DMR
			{
				weapon="STB73_M392_DMR";
				count=2;
			};
			class _xx_STB73_M295_BMR
			{
				weapon="STB73_M295_BMR";
				count=2;
			};
		};
		class TransportItems
	...
	class STB73_supply_Sniper: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
		...
		class TransportMagazines
		{
			...
			class _xx_STB73_M232_145x114x4_APFSDS
			{
				magazine="STB73_M232_145x114x4_APFSDS";
				count=20;
			};
			class _xx_STB73_M232_145x114x4_APFSDS_TC
			{
				magazine="STB73_M232_145x114x4_APFSDS_TC";
				count=20;
			};
			class _xx_STB73_M232_145x114x8_APFSDS
			{
				magazine="STB73_M232_145x114x8_APFSDS";
				count=5;
			};
			class _xx_STB73_M232_145x114x8_APFSDS_TC
			{
				magazine="STB73_M232_145x114x8_APFSDS_TC";
				count=5;
			};
		};
		class TransportWeapons
		{
			class _xx_STB73_SRS99AM
			{
				weapon="STB73_SRS99AM";
				count=2;
			};
			class _xx_STB73_SRS99AM_Stealth
			{
				weapon="STB73_SRS99AM_Stealth";
				count=2;
			};
		};
		class TransportItems
	...
	class STB73_supply_Autorifles: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
		...
		class TransportMagazines
		{
			...
			class _xx_STB73_200rnd_M247_Mag
			{
				magazine="STB73_200rnd_M247_Mag";
				count=10;
			};
			class _xx_STB73_200rnd_M247_Mag_Tracer
			{
				magazine="STB73_200rnd_M247_Mag_Tracer";
				count=15;
			};
			class _xx_STB73_100rnd_M247_Mag
			{
				magazine="STB73_100rnd_M247_Mag";
				count=10;
			};
			class _xx_STB73_100rnd_M247_Mag_Tracer
			{
				magazine="STB73_100rnd_M247_Mag_Tracer";
				count=10;
			};
		...
		class TransportWeapons
		{
			class _xx_STB73_M247
			{
				weapon="STB73_M247";
				count=2;
			};
			class _xx_STB73_H4_SAW
			{
				weapon="STB73_H4_SAW";
				count=2;
			};
		...
		class TransportItems
		{
			...
			class _xx_optre_mSTB73_smartlink
			{
				name="optre_mSTB73_smartlink";
				count=2;
			};
	...
	class STB73_supply_ATLauncher: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
		...
		class TransportMagazines
		{
			...
			class _xx_STB73_1Rnd_50x137_HE
			{
				magazine="STB73_1Rnd_50x137_HE";
				count=10;
			};
			class _xx_STB73_1Rnd_50x137_HEAT
			{
				magazine="STB73_1Rnd_50x137_HEAT";
				count=10;
			};
			class _xx_STB73_1Rnd_50x137_PEN
			{
				magazine="STB73_1Rnd_50x137_PEN";
				count=10;
			};
			class _xx_STB73_HEAT
			{
				magazine="STB73_HEAT";
				count=10;
			};
			class _xx_STB73_HEAP
			{
				magazine="STB73_HEAP";
				count=10;
			};
			class _xx_STB73_HEAA
			{
				magazine="STB73_HEAA";
				count=10;
			};
		...
		class TransportWeapons
		{
			class _xx_STB73_M96_LAW
			{
				weapon="STB73_M96_LAW";
				count=3;
			};
			class _xx_STB73_Fang2
			{
				weapon="STB73_Fang2";
				count=3;
			};
			class _xx_STB73_Fang
			{
				weapon="STB73_Fang";
				count=3;
			};
			class _xx_STB73_M41_SSR
			{
				weapon="STB73_M41_SSR";
				count=3;
			};
		};
	};
	class STB73_supply_ExplosivesPack: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
	...
	class STB73_supply_TACResupply: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
	...
	class STB73_supply_Emptypod: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
		...
		class STB73_supply_Light: STB73_SupplyPod
	{
		scope = 2; // Visible in Zeus and Eden
    	scopeCurator = 2; // Allow spawning in Zeus
			...
			class box1
			{
				...
				class values
				{
					...
					class n3
					{
						...
						value="STB73_supply_Autorifles";
					};
					class n4
					{
						name="73rd AT Launcher Supply Pod";
						value="STB73_supply_ATLauncher";
					};
					class n5
					{
						name="73rd Explosives Supply Pod";
						value="STB73_supply_ExplosivesPack";
					};
					class n6
					{
						name="73rd Grenadier Supply Pod";
						value="STB73_supply_ARGL";
					};
					class n7
					{
						name="73rd Shotgun Supply Pod";
						value="STB73_supply_Breacher";
					};
					class n8
					{
						name="73rd Marksman Supply Pod";
						value="STB73_supply_Marksman";
					};
					class n9
					{
						name="73rd Sniper Supply Pod";
						value="STB73_supply_Sniper";
					};
					class n10
					{
						name="73rd Medical Supply Pod";
						value="STB73_SupplyPod_NEWACE_Medical";
					};
					class n11
					{
					...
					class n12
					{
						...
						value="STB73_SupplyPod_Mortar";
					};
					class n13
					{
						name="73rd Static HMG";
						value="STB73_SupplyPod_StaticHMG";
					};
					class n14
					{
						name="73rd Static HMG Ammo";
						value="STB73_SupplyPod_StaticHMGAmmo";
					};
					class n15
					{
						name="73rd Static GMG";
						value="STB73_SupplyPod_StaticGMG";
					};
					class n16
					{
						name="73rd Static GMG Ammo";
						value="STB73_SupplyPod_StaticGMGAmmo";
					};
					...
					class n20
					{
						...
						value="STB73_supply_TACResupply";
					};
					class n21
					{
						name="73rd Squad Supply Pod";
						value="STB73_supply_Squad";
					};
					class n22
					{
						name="73rd Empty Supply pod";
						value="STB73_supply_Emptypod";
					};
				};
			};
		};
	};
	class STB73_SupplyPod_Light: STB73_SupplyPod
	{
		scope=2;
		displayname="73rd Supply Pod Light";
		class TransportMagazines
