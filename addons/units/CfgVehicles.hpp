class CfgVehicles {
    ...
    class STB73_Aviator: STB73_UnitBase
    {
        ...
        linkedItems[] = {"STB73_M43A_Aviator_Black","STB73_VX19_Helmet_Base","ItemMap","ItemcTab","ItemRadio","ItemCompass","ItemWatch"};
        respawnLinkedItems[] = {"STB73_M43A_Aviator_Black","STB73_VX19_Helmet_Base","ItemMap","ItemcTab","ItemRadio","ItemCompass","ItemWatch"};
