...
myaction = ['3rnds_10','3 Rounds','',{ [3,10,0,500] spawn STB73_fnc_setCallMortarFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Mortars","10_S"], myaction] call ace_interact_menu_fnc_addActionToObject;

myaction = ['6rnds_10','6 Rounds','',{ [6,10,0,500] spawn STB73_fnc_setCallMortarFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Mortars","10_S"], myaction] call ace_interact_menu_fnc_addActionToObject;

myaction = ['10rnds_10','10 Rounds','',{ [10,10,0,500] spawn STB73_fnc_setCallMortarFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Mortars","10_S"], myaction] call ace_interact_menu_fnc_addActionToObject;
...
myaction = ['3rnds_30','6 Rounds','',{ [6,30,0,500] spawn STB73_fnc_setCallMortarFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Mortars","30_S"], myaction] call ace_interact_menu_fnc_addActionToObject;

myaction = ['6rnds_30','10 Rounds','',{ [10,30,0,500] spawn STB73_fnc_setCallMortarFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Mortars","30_S"], myaction] call ace_interact_menu_fnc_addActionToObject;

myaction = ['10rnds_30','30 Rounds','',{ [15,30,0,500] spawn STB73_fnc_setCallMortarFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Mortars","30_S"], myaction] call ace_interact_menu_fnc_addActionToObject;
...
myaction = ['3rnds_100','15 Rounds','',{ [15,100,3,500] spawn STB73_fnc_setCallArtyFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Artillery","100_S","100_S_W"], myaction] call ace_interact_menu_fnc_addActionToObject;

myaction = ['6rnds_100','25 Rounds','',{ [25,100,3,500] spawn STB73_fnc_setCallArtyFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
[_player, 1, ["ACE_SelfActions", "Support_menu", "Artillery","100_S","100_S_W"], myaction] call ace_interact_menu_fnc_addActionToObject;
...
myaction = ['10rnds_100','Are you super duper sure?','',{ [45,100,3,500] spawn STB73_fnc_setCallArtyFireSupport73STB; },{true}] call ace_interact_menu_fnc_createAction;
