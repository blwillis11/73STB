...
class 73_COP_Prophet_Bodyguard: 73_COP_UnitBase
{
    ...
    linkedItems[] = {"CoP_V_M43A_Light_3_White","TCP_H_Helmet_CH43A_White","ReconCloaks_NV_Hood_Down_blk","MK50"};
    respawnLinkedItems[] = {"CoP_V_M43A_Light_3_White","TCP_H_Helmet_CH43A_White","ReconCloaks_NV_Hood_Down_blk","MK50"};
...
class 73_COP_Prophet_Lead: 73_COP_UnitBase
{
    ...
    linkedItems[] = {"CoP_V_M43A_Light_3_White","ReconCloaks_H_Hood_blk","G_CBRN_B_black"};
    respawnLinkedItems[] = {"CoP_V_M43A_Light_3_White","ReconCloaks_H_Hood_blk","G_CBRN_B_black"};
...
class 73_COP_Cult_SF_TeamLead: 73_COP_UnitBase
{
    ...
    linkedItems[] = {"CoP_V_M43A_GungnirL_3_2_Black","TCP_H_Helmet_ECH43A_Black_Red","OPTRE_NVG_HUL3_Gray","TCP_G_BalaclavaTacticalGlasses_Black_Black"};
    respawnLinkedItems[] = {"CoP_V_M43A_GungnirL_3_2_Black","TCP_H_Helmet_ECH43A_Black_Red","OPTRE_NVG_HUL3_Gray","TCP_G_BalaclavaTacticalGlasses_Black_Black"};
