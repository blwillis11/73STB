...
class STB73_B_10x40_Ball: OPTRE_B_762x51_Ball
{
    caliber = 6;
    hit = 22;
    indirectHit=0;
...
class STB73_B_10x40_Ball_Tracer: STB73_B_10x40_Ball
{
    model = "\A3\Weapons_f\Data\bullettracer\tracer_red";
};
class STB73_B_10x40_Ball_Tracer_Yellow: STB73_B_10x40_Ball
{
    model = "\A3\Weapons_f\Data\bullettracer\tracer_yellow";
};
class STB73_B_10x40_HVAP: STB73_B_10x40_Ball
{
    caliber = 8;
    hit = 28;
    indirectHit=0;
...
class STB73_B_10x40_HVAP_Tracer: STB73_B_10x40_HVAP
{
    model = "\A3\Weapons_f\Data\bullettracer\tracer_red";
};
class STB73_B_10x40_HVAP_Tracer_Yellow: STB73_B_10x40_HVAP
{
    model = "\A3\Weapons_f\Data\bullettracer\tracer_yellow";
};
