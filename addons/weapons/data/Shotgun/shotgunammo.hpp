...
class STB73_8Gauge_Pellets: OPTRE_8Gauge_Pellets
{
...
class STB73_8Gauge_Slugs: OPTRE_8Gauge_Slugs
{
    cartridge = "FxCartridge_slug";
    caliber = 8;
    hit = 40;
...
class STB73_8Gauge_HEDP: OPTRE_8Gauge_HEDP
{
    cartridge = "FxCartridge_slug";
    hit = 60;
    indirectHit = 30;
...
class STB73_12Gauge_Pellets: STB73_8Gauge_Pellets
{
    ...
    submunitionAmmo = "STB73_12Gauge_Pellets_Deploy";
...
class STB73_12Gauge_Pellets_Deploy: OPTRE_12Gauge_Pellets_Deploy
{
    model = "\A3\Weapons_f\Data\bullettracer\tracer_red";
    tracerScale = 1;
    tracerStartTime = 0;
...
class STB73_12Gauge_HE: OPTRE_12Gauge_HE
{
    hit = 18;
    caliber = 2;
    indirectHit = 4;
