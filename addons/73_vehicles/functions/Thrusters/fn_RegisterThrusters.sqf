...
_vic setVariable ["STB73_Thrusters_Usable", _thrusters];
_vic setVariable ["STB73_Afterburners_Usable", _afterBurners];
_vic setVariable ["STB73_AnimateThrusters", _animate];